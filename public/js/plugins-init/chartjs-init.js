 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(59, 76, 184, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(59, 76, 184, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(59, 76, 184, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(59, 76, 184, 0.5)");

			const barChart_3gradientStroke2 = barChart_3.createLinearGradient(50, 100, 50, 50);
			barChart_3gradientStroke2.addColorStop(0, "rgba(55, 209, 89, 1)");
			barChart_3gradientStroke2.addColorStop(1, "rgba(55, 209, 89, 1)");

			const barChart_3gradientStroke3 = barChart_3.createLinearGradient(50, 100, 50, 50);
			barChart_3gradientStroke3.addColorStop(0, "rgba(182, 85, 228, 1)");
			barChart_3gradientStroke3.addColorStop(1, "rgba(182, 85, 228, 1)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(59, 76, 184, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(59, 76, 184, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(59, 76, 184, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(59, 76, 184, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(59, 76, 184, 0.5)");

			const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke2.addColorStop(0, "rgba(255, 159, 15, 1)");
			lineChart_3gradientStroke2.addColorStop(1, "rgba(255, 159, 15, 1)");
	...
	var areaChart2 = function(){	
		...
		if(jQuery('#areaChart_2').length > 0 ){
			...
			areaChart_2gradientStroke.addColorStop(0, "rgba(182, 85, 228, 0.2)");
			areaChart_2gradientStroke.addColorStop(1, "rgba(182, 85, 228, 0)");
				...
				data: {
					...
					datasets: [
						...
						}, 
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(255, 159, 15, .5)'
						}
					]
				},
				options: {
